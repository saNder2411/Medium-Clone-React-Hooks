...
export default class MediumCloneService {
  ...
  signUpUser = async (userAuthData) => {
    const userData = await this._postResource(`users`, userAuthData);

    return userData;
  };

  signInUser = async (userAuthData) => {
    const userData = await this._postResource(`users/login`, userAuthData);
